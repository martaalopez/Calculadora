...
class CalculadoraTest {
  ...
  @Test
  @DisplayName("Raíz cuadrada de un número conocido")
  void testRaizCuadrada() {
      Assertions.assertEquals(4.0, miCalculadora.raizCuadrada(16));
  }

    @Test
    @DisplayName("Raíz cuadrada de otro número conocido")
    void testRaizCuadradaOtroNumero() {
        Assertions.assertEquals(8.0, miCalculadora.raizCuadrada(64));
    }

    @Test
    @DisplayName("Raíz cuadrada de 1")
    void testRaizCuadradaDeUno() {
        Assertions.assertEquals(1.0, miCalculadora.raizCuadrada(1));
    }

    @Test
    @DisplayName("Raíz cuadrada de 0")
    void testRaizCuadradaDeCero() {
        Assertions.assertEquals(0.0, miCalculadora.raizCuadrada(0));
    }

    @Test
    @DisplayName("Raíz cuadrada de un número negativo")
    void testRaizCuadradaDeNumeroNegativo() {
        Throwable exception = Assertions.assertThrows(IllegalArgumentException.class, () -> {
            miCalculadora.raizCuadrada(-1);
        });
        Assertions.assertEquals("El radicando no puede ser negativo", exception.getMessage());
    }
}